...
async function main() {
  ...
  const settings = await prisma.settings.upsert({
    ...
    create: {
      ...
      heroTitleRu: 'Создаём премиум мебель для вашего бизнеса',
      heroTitleEn: 'Creating Premium Furniture for Your Business',
      heroSubtitleRu: 'От 3D-дизайна до доставки. Собственное производство. СНГ и Европа',
      heroSubtitleEn: 'From 3D design to delivery. Own production. CIS and Europe',
    },
  })
  ...
  const products = await Promise.all([
    prisma.product.create({
      data: {
        slug: 'rocking-chair-premium',
        nameRu: 'Кресло-качалка премиум',
        nameEn: 'Premium Rocking Chair',
        descriptionRu: 'Премиальное кресло-качалка ручной работы из массива дуба с итальянской обивкой. Идеально подходит для кафе, террас и домашних интерьеров. Каждое кресло изготавливается индивидуально с учетом пожеланий клиента.',
        descriptionEn: 'Premium handmade rocking chair made of solid oak with Italian upholstery. Perfect for cafes, terraces and home interiors. Each chair is made individually taking into account the wishes of the client.',
        shortDescRu: 'Ручная работа. Массив дуба + итальянская обивка',
        shortDescEn: 'Handmade. Solid oak + Italian upholstery',
  ...
  const portfolio = await Promise.all([
    ...
    prisma.portfolio.create({
      data: {
        ...
        descriptionRu: 'Уличная мебель премиум класса для летней террасы',
        descriptionEn: 'Premium outdoor furniture for summer terrace',
